...
ggplot(nc[!is.na(nc$habit),],aes(habit,weight))+
...
inference(y = weeks, data = nc, conf_level=0.99,statistic = "mean", type = "ci", method = "theoretical")
```
...
summary(nc[nc$mature=='mature mom',]$mage)
summary(nc[nc$mature=='younger mom',]$mage)
